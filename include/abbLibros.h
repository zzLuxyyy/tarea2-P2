/*
  ...
  Un elemento de tipo TABBLibros es un árbol binario de búsqueda que almacena una colección de elementos 
...
// Define el tipo TABBLibros como un puntero a rep_abbLibros.
